//Tugas KI
//Kode Program Untuk Melakukan Steganografi dan Kriptografi Menggunakan LSB dan DES
package lsbdes;
import java.io.*;
...
public class StegCrypt 
{
    ...
    public boolean hide(String textfnm, String imfnm)
    {
        ...
        return writeimagetofile(fnm+"+new.png", im);
    }
    ...
    private static String readtextfile(String fnm)
    {
        ...
        {
            System.out.println("File Tidak Terbaca : " + fnm);
        }
        finally
        {
            try
        ...
        System.out.println("Membaca File Text" + fnm);
        return sb.toString();
    }
    ...
    private static BufferedImage loadimage(String imfnm)
    {
        ...
        {
            System.out.println("Tidak dapat memuat image..." + e.getMessage());
        }
        return im;
    ...
    private static boolean dohide(byte[] imbytes, byte[] stego)
    {
        ...
        {
            System.out.println("ukuran gambar kurang sesuai");
            return false;
    ...
    private static boolean writeimagetofile(String outfnm, BufferedImage im)
    {
        ...
        {
            System.out.println("Tidak dapat memasukan gambar ke: " + outfnm);
            return false;
        }
    }
    ...
    private static boolean canoverwrite(String fnm)
    {
        ...
        {   
            n = JOptionPane.showConfirmDialog(null,"File "+fnm+" File SUdah ada dengan nama yang sama.Ingin Merubahnya?","File exists!", JOptionPane.YES_NO_OPTION);
